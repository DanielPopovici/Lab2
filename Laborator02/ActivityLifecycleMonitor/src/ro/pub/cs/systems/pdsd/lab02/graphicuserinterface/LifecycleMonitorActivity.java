...
public class LifecycleMonitorActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    if(savedInstanceState != null) {
	    	Log.d(Constants.TAG, "onCreate() method was invoked. It was invoked before.");
	    } 
	    else {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
	  ...
	  protected void onSaveInstanceState(Bundle savedInstanceState) {
		...
		if(rememberMe.isChecked()) {
			Log.d(Constants.TAG, "remember me is checked");
	  ...
	  protected void onRestoreInstanceState(Bundle savedInstanceState) {
		...
		Boolean chkbx = savedInstanceState.getBoolean(Constants.REMEMBER_ME_CHECKBOX);
		rememberMe.setChecked(chkbx);
		if(chkbx) {
			
			username = savedInstanceState.getString(Constants.USERNAME_EDIT_TEXT);
			pass = savedInstanceState.getString(Constants.PASSWORD_EDIT_TEXT);
